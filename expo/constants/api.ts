export const LTX_API_KEY = process.env.EXPO_PUBLIC_LTX_API_KEY || '';
export const WEBSITE_URL = 'https://synthesis.serapiscode.com/?usrtv=MzEz';
...
export const XUMM_API_KEY = process.env.EXPO_PUBLIC_XUMM_API_KEY || '';
